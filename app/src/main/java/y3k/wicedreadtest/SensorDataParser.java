...
public class SensorDataParser {
    ...
    public static int[] getAccelorometerData(byte[] sensorData, int offset) {
    	return new int[]{
        	getTwoByteValue(sensorData, offset),
        	getTwoByteValue(sensorData, offset + 2),
        	getTwoByteValue(sensorData, offset + 4)
    	};
    }

    public static int[] getMagnometerData(byte[] sensorData, int offset) {
    	return new int[]{
        	getTwoByteValue(sensorData, offset),
        	getTwoByteValue(sensorData, offset + 2),
        	getTwoByteValue(sensorData, offset + 4)
    ...
    public static int[] getGyroData(byte[] sensorData, int offset) {
    	return new int[]{
    			getTwoByteValue(sensorData, offset) / 100,
    			getTwoByteValue(sensorData, offset + 2) / 100,
    			getTwoByteValue(sensorData, offset + 4) / 100
    	};
    }
